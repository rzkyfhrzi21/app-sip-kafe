...
// =====================================================
// FILEPOND: CSV DATASET (COMMA DELIMITED)
// =====================================================
const csvInput = document.querySelector(".filepond-csv");
...
if (csvInput) {
  FilePond.create(csvInput, {
    ...
    labelIdle:
      'Drag & Drop <b>dataset CSV</b> atau <span class="filepond--label-action">Browse</span>',

    labelFileTypeNotAllowed: "Format file harus CSV",
    labelMaxFileSizeExceeded: "Ukuran file terlalu besar",
    labelMaxFileSize: "Ukuran maksimal 10 MB",
  });
}
